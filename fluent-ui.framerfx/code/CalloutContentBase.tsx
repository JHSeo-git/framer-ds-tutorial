...
const InnerCalloutContentBase = props => {
    return <System.CalloutContentBase {...props}></System.CalloutContentBase>
}

export const CalloutContentBase = withHOC(InnerCalloutContentBase)
...
addPropertyControls(CalloutContentBase, {
    target: {
        title: "Target",
