...
const InnerTeachingBubbleContentBase = props => {
    return <System.TeachingBubbleContentBase {...props}></System.TeachingBubbleContentBase>
}

export const TeachingBubbleContentBase = withHOC(InnerTeachingBubbleContentBase)
