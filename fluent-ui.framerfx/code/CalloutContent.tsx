...
const InnerCalloutContent = props => {
    return <System.CalloutContent {...props}></System.CalloutContent>
}

export const CalloutContent = withHOC(InnerCalloutContent)
...
addPropertyControls(CalloutContent, {
    target: {
        title: "Target",
