...
declare const Pre: React.ForwardRefExoticComponent<{
    children: React.ReactNode;
} & Pick<Omit<Pick<React.DetailedHTMLProps<React.HTMLAttributes<HTMLPreElement>, HTMLPreElement>, "key" | keyof React.HTMLAttributes<HTMLPreElement>> & {
    ref?: ((instance: HTMLPreElement | null) => void) | React.RefObject<HTMLPreElement> | null | undefined;
}, "css" | "variant"> & import("@stitches/react/types/styled-component").TransformProps<{
    variant?: "primary" | "secondary" | "teritary" | undefined;
}, {
    sm: string;
    md: string;
    lg: string;
...
}, "key" | "css" | keyof React.HTMLAttributes<HTMLPreElement> | "variant"> & React.RefAttributes<HTMLPreElement>>;
declare const BasePre: import("@stitches/react/types/styled-component").StyledComponent<"pre", {
    variant?: "primary" | "secondary" | "teritary" | undefined;
}, {
    sm: string;
    md: string;
