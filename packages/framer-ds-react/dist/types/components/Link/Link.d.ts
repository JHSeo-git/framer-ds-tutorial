...
declare const Link: React.ForwardRefExoticComponent<{
    children: React.ReactNode;
} & Pick<Omit<Pick<React.DetailedHTMLProps<React.AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>, keyof React.AnchorHTMLAttributes<HTMLAnchorElement> | "key"> & {
