...
declare const Code: React.ForwardRefExoticComponent<{
    children: React.ReactNode;
} & Pick<Omit<Pick<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>, keyof React.HTMLAttributes<HTMLElement> | "key"> & {
    ref?: ((instance: HTMLElement | null) => void) | React.RefObject<HTMLElement> | null | undefined;
}, "css" | "variant"> & import("@stitches/react/types/styled-component").TransformProps<{
    variant?: "inherit" | "grayScale" | "primary" | undefined;
}, {
    sm: string;
    md: string;
    lg: string;
...
}, keyof React.HTMLAttributes<HTMLElement> | "key" | "css" | "variant"> & React.RefAttributes<HTMLElement>>;
declare const BaseCode: import("@stitches/react/types/styled-component").StyledComponent<"code", {
    variant?: "inherit" | "grayScale" | "primary" | undefined;
}, {
    sm: string;
    md: string;
